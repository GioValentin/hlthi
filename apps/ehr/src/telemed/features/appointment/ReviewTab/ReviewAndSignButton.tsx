      ...
      >
        <Box>
          <ConfirmationDialog
            ...
            description="Are you sure you have reviewed the patient chart, performed the examination, defined the diagnoses, Plan / Medical Decision Making and E&M code and ready to sing this patient."
            response={handleSign}
            actionButtons={{
              proceed: {
                text: 'Sign',
