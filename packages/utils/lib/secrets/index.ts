...
export enum SecretsKeys {
  ...
  STRIPE_BILLING_CONFIGURATION = 'STRIPE_BILLING_CONFIGURATION',

  STRIPE_PRODUCT_BASE_ID = 'STRIPE_PRODUCT_BASE_ID',
  STRIPE_PRODUCT_ON_DEMAND_ID = 'STRIPE_PRODUCT_ON_DEMAND_ID',
  STRIPE_PRODUCT_STANDARD_CARE_ID = 'STRIPE_PRODUCT_STANDARD_CARE_ID',
  STRIPE_PRODUCT_FREE_ID = 'STRIPE_PRODUCT_FREE_ID',
