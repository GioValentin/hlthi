...
import { TIMEZONE_EXTENSION_URL } from '../src/shared';
  ...
  item: [
    ...
    },
    {
      ...
      item: [
        ...
        {
          linkId: 'consent-to-visit-fee',
          text: 'I understand that I will be charged a visit fee of $29.99 if I have not used any this month. This will be billed to the billing method on file.',
          type: 'boolean',
          required: true,
        },
        {
