...
ZIP_ORDER=('get-patients' 'get-providers' 'get-groups' 'get-locations' 'get-paperwork' 'create-paperwork' 'update-paperwork' 'update-appointment' 'create-appointment' 'get-appointments' 'get-schedule' 'cancel-telemed-appointment' 'cancel-in-person-appointment' 'get-wait-status' 'join-call' 'video-chat-invites-create' 'video-chat-invites-cancel' 'video-chat-invites-list' 'get-presigned-file-url' 'payment-methods-setup' 'payment-methods-list' 'payment-methods-set-default' 'payment-methods-delete' 'get-billing-portal' 'create-checkout-session' 'get-stripe-customer' 'get-patient-subscription-status' 'get-provider' 'check-sms-verification' 'create-account' 'create-sms-verification')
