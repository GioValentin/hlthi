...
# Zip
ZIP_ORDER=("deactivate-user" "get-appointments" "get-telemed-appointments" "notifications-updater" "change-telemed-appointment-status" "get-conversation" "get-employees" "update-user" "get-user" "init-telemed-session" "save-chart-data" "get-chart-data" "delete-chart-data" "save-patient-instruction" "get-patient-instructions" "sync-user" "icd-search" "init-chat-telemed-session")
